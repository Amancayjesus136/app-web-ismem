        ...
        <nav class="navbar navbar-expand-lg navbar-landing navbar-light bg-custom fixed-top" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index.html">
                    <img src="{{ asset('assets/img/logo-ismem2024.png') }}" class="card-logo card-logo-dark" alt="logo dark" height="60" style="border-radius: 30px">
                    <img src="{{ asset('assets/img/logo-ismem2024.png') }}" class="card-logo card-logo-light" alt="logo light" height="60" style="border-radius: 30px">
                </a>
