                        ...
                        <div class="p-3">
                            <div class="row align-items-center">
                                ...
                                {{-- <div class="col-auto dropdown-tabs">
                                    <span class="badge badge-soft-light fs-13"> {{ $totalNotificaciones }} Nuevos</span>
                                </div> --}}
                            </div>
                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-1">
                                            <a href="#!" class="stretched-link">
                                                <h6 class="mt-0 mb-2 fs-13 lh-base">{{ $data['message'] ?? 'Mensaje no disponible' }}</h6>
                                            </a>
            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="d-flex align-items-center">
                        <img class="rounded-circle header-profile-user" src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('assets3/images/sin-foto.jpg') }}" alt="Header Avatar">
                        <span class="text-start ms-xl-2">
                            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::user()->name }}</span>
                            <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Usuario registrado</span>
                        </span>
                    </span>
                </button>
                <div class="dropdown-menu dropdown-menu-end">
